				...
				<div className="flex flex-row flex-wrap justify-center items-center p-2">
					...
					<div className="flex flex-col flex-wrap items-center justify-center p-2 h-full">
						<h1 className="text-3xl font-bold">
							Oh, hi! I am{" "}
							<span className="text-accent-500 dark:text-accent-400 font-mono">Tapnisu</span>!
						</h1>

						<p>
							My name is{" "}
							<span className="text-accent-500 dark:text-accent-400 font-mono font-semibold">
								Alexiy Rybin
							</span>
							.
							<br />
						...
						{[
							...
							(repo: {
								...
								>
									<Link
										href={repo.url}
										className="text-xl cursor-pointer text-main-900 dark:text-main-100 hover:text-accent-500 dark:hover:text-accent-400 transition-colors"
									>
										{repo.name}
									</Link>
